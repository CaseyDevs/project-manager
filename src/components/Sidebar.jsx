...
export default function Sidebar({ projectList, onHandleStartAddProject, onSelectedProject, selectedProjectId }) {
    return (
        <aside className="sidebar px-10 py-20 w-1/4 flex-initial flex-col rounded-r-2xl bg-black text-white">
            <h2 className="font-medium lg:text-2xl sm:text-xl xs:text-s">YOUR PROJECTS</h2>
            <p>
            ...
            <ul>
                ...
                {projectList.map((project) => {
                    ...
                    let cssClasses = "w-full text-left px-2 py-1 rounded-sm my-1 text-stone-400 hover:text-stone-200 hover:bg-stone-800 overflow-hidden"
