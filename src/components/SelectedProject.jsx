        ...
        <div className="w-[35rem] mt-16">
            <header className="pb-4 mb-4 border-b-2 border-stone-300">
                <div className="flex items-center justify-between">
                    <h1
                        className="text-3xl font-bold text-stone-600 mb-2 overflow-hidden text-ellipsis whitespace-nowrap sm:whitespace-normal"
                        title={project.title}
                    >
                        {project.title}
                    </h1>
                ...
                <p className="text-stone-600 whitespace-pre-wrap break-words">{project.description}</p>
            </header>
